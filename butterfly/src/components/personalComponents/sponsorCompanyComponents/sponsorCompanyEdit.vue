<template>
  <div>
    <TitleName titleName="主办方公司资料"/>
    <div class="sponsor-company-editcontent">
      <PublicPerson headName="主办方公司信息" blockType="info" v-if="!showPerInfoFlag">
      ...
      <div class="sponsor-company-edit-infomation">
...
<script>
  ...
  import PersonalInfo from '../sponsorCompanyComponents/sponsorCompanyFirst'
...
<style lang="less">
  ...
  .sponsor-company-edit-infomation{
    .btn-box {
      display: none;
    }
  }
