<template>
  <div>
    <TitleName titleName="主办方个人资料"/>
    <div class="sponsor-editcontent">
      <PublicPerson headName="主办方个人信息" blockType="info" v-if="!showPerInfoFlag">
      ...
      <div class="sponsor-edit-infomation">
...
<script>
  ...
  import PersonalInfo from '../sponsorComponents/sponsorFirstApply'
